...
class _SearchScreenState extends State<SearchScreen> {
  ...
  //     foodid: _searchList[index]["foodid"],
  //     foodname: _searchList[index]["foodname"],
  //     foodcat: _searchList[index]["foodcat"],
  //     foodprice: _searchList[index]["food_price"],
